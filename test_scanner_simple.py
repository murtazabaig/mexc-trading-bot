#!/usr/bin/env python3
"""
Simplified validation script for scanner job functionality.
"""
...
def test_ohlcv_cache():
    ...
    from src.jobs.scanner import OHLCVCache
...
async def test_scanner_job_creation():
    ...
    from src.jobs.scanner import ScannerJob, OHLCVCache
    ...
    try:
        ...
        indicators = await scanner._calculate_indicators(cache_data)
